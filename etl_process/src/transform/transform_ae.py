...
print(ae_files)
# If not files are found this raises an error
if not ae_files:
...
# for example if "period" is present but not "reporting period" itll only keep "period": "period" in existing_rename_map
...
# Drops any cols we dont want to keep
